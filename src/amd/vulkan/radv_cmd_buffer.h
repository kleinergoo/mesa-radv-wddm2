...
typedef uint64_t radv_dynamic_state_bits;

#define RADV_DYNAMIC_VIEWPORT                    (1ull << 0)
#define RADV_DYNAMIC_SCISSOR                     (1ull << 1)
#define RADV_DYNAMIC_LINE_WIDTH                  (1ull << 2)
#define RADV_DYNAMIC_DEPTH_BIAS                  (1ull << 3)
#define RADV_DYNAMIC_BLEND_CONSTANTS             (1ull << 4)
#define RADV_DYNAMIC_DEPTH_BOUNDS                (1ull << 5)
#define RADV_DYNAMIC_STENCIL_COMPARE_MASK        (1ull << 6)
#define RADV_DYNAMIC_STENCIL_WRITE_MASK          (1ull << 7)
#define RADV_DYNAMIC_STENCIL_REFERENCE           (1ull << 8)
#define RADV_DYNAMIC_DISCARD_RECTANGLE           (1ull << 9)
#define RADV_DYNAMIC_SAMPLE_LOCATIONS            (1ull << 10)
#define RADV_DYNAMIC_LINE_STIPPLE                (1ull << 11)
#define RADV_DYNAMIC_CULL_MODE                   (1ull << 12)
#define RADV_DYNAMIC_FRONT_FACE                  (1ull << 13)
#define RADV_DYNAMIC_PRIMITIVE_TOPOLOGY          (1ull << 14)
#define RADV_DYNAMIC_DEPTH_TEST_ENABLE           (1ull << 15)
#define RADV_DYNAMIC_DEPTH_WRITE_ENABLE          (1ull << 16)
#define RADV_DYNAMIC_DEPTH_COMPARE_OP            (1ull << 17)
#define RADV_DYNAMIC_DEPTH_BOUNDS_TEST_ENABLE    (1ull << 18)
#define RADV_DYNAMIC_STENCIL_TEST_ENABLE         (1ull << 19)
#define RADV_DYNAMIC_STENCIL_OP                  (1ull << 20)
#define RADV_DYNAMIC_VERTEX_INPUT_BINDING_STRIDE (1ull << 21)
#define RADV_DYNAMIC_FRAGMENT_SHADING_RATE       (1ull << 22)
#define RADV_DYNAMIC_PATCH_CONTROL_POINTS        (1ull << 23)
#define RADV_DYNAMIC_RASTERIZER_DISCARD_ENABLE   (1ull << 24)
#define RADV_DYNAMIC_DEPTH_BIAS_ENABLE           (1ull << 25)
#define RADV_DYNAMIC_LOGIC_OP                    (1ull << 26)
#define RADV_DYNAMIC_PRIMITIVE_RESTART_ENABLE    (1ull << 27)
#define RADV_DYNAMIC_COLOR_WRITE_ENABLE          (1ull << 28)
#define RADV_DYNAMIC_VERTEX_INPUT                (1ull << 29)
#define RADV_DYNAMIC_POLYGON_MODE                (1ull << 30)
#define RADV_DYNAMIC_TESS_DOMAIN_ORIGIN          (1ull << 31)
#define RADV_DYNAMIC_LOGIC_OP_ENABLE             (1ull << 32)
#define RADV_DYNAMIC_LINE_STIPPLE_ENABLE         (1ull << 33)
#define RADV_DYNAMIC_ALPHA_TO_COVERAGE_ENABLE    (1ull << 34)
#define RADV_DYNAMIC_SAMPLE_MASK                 (1ull << 35)
#define RADV_DYNAMIC_DEPTH_CLIP_ENABLE           (1ull << 36)
#define RADV_DYNAMIC_CONSERVATIVE_RAST_MODE      (1ull << 37)
#define RADV_DYNAMIC_DEPTH_CLIP_NEGATIVE_ONE_TO_ONE (1ull << 38)
#define RADV_DYNAMIC_PROVOKING_VERTEX_MODE       (1ull << 39)
#define RADV_DYNAMIC_DEPTH_CLAMP_ENABLE          (1ull << 40)
#define RADV_DYNAMIC_COLOR_WRITE_MASK            (1ull << 41)
#define RADV_DYNAMIC_COLOR_BLEND_ENABLE          (1ull << 42)
#define RADV_DYNAMIC_RASTERIZATION_SAMPLES       (1ull << 43)
#define RADV_DYNAMIC_LINE_RASTERIZATION_MODE     (1ull << 44)
#define RADV_DYNAMIC_COLOR_BLEND_EQUATION        (1ull << 45)
#define RADV_DYNAMIC_DISCARD_RECTANGLE_ENABLE    (1ull << 46)
#define RADV_DYNAMIC_DISCARD_RECTANGLE_MODE      (1ull << 47)
#define RADV_DYNAMIC_ATTACHMENT_FEEDBACK_LOOP_ENABLE (1ull << 48)
#define RADV_DYNAMIC_SAMPLE_LOCATIONS_ENABLE     (1ull << 49)
#define RADV_DYNAMIC_ALPHA_TO_ONE_ENABLE         (1ull << 50)
#define RADV_DYNAMIC_COLOR_ATTACHMENT_MAP        (1ull << 51)
#define RADV_DYNAMIC_INPUT_ATTACHMENT_MAP        (1ull << 52)
#define RADV_DYNAMIC_DEPTH_CLAMP_RANGE           (1ull << 53)
#define RADV_DYNAMIC_VIEWPORT_WITH_COUNT         (1ull << 54)
#define RADV_DYNAMIC_SCISSOR_WITH_COUNT          (1ull << 55)
#define RADV_DYNAMIC_ALL                        ((1ull << 56) - 1)

typedef uint64_t radv_cmd_dirty_bits;

#define RADV_CMD_DIRTY_PIPELINE                (1ull << 0)
#define RADV_CMD_DIRTY_INDEX_BUFFER            (1ull << 1)
#define RADV_CMD_DIRTY_VERTEX_BUFFER           (1ull << 2)
#define RADV_CMD_DIRTY_STREAMOUT_BUFFER        (1ull << 3)
#define RADV_CMD_DIRTY_GUARDBAND               (1ull << 4)
#define RADV_CMD_DIRTY_RBPLUS                  (1ull << 5)
#define RADV_CMD_DIRTY_OCCLUSION_QUERY         (1ull << 6)
#define RADV_CMD_DIRTY_DB_SHADER_CONTROL       (1ull << 7)
#define RADV_CMD_DIRTY_STREAMOUT_ENABLE        (1ull << 8)
#define RADV_CMD_DIRTY_GRAPHICS_SHADERS        (1ull << 9)
#define RADV_CMD_DIRTY_FRAGMENT_OUTPUT         (1ull << 10)
#define RADV_CMD_DIRTY_PS_STATE                (1ull << 11)
#define RADV_CMD_DIRTY_NGG_STATE               (1ull << 12)
#define RADV_CMD_DIRTY_TASK_STATE              (1ull << 13)
#define RADV_CMD_DIRTY_DEPTH_STENCIL_STATE     (1ull << 14)
#define RADV_CMD_DIRTY_RASTER_STATE            (1ull << 15)
#define RADV_CMD_DIRTY_MSAA_STATE              (1ull << 16)
#define RADV_CMD_DIRTY_CLIP_RECTS_STATE        (1ull << 17)
#define RADV_CMD_DIRTY_TCS_TES_STATE           (1ull << 18)
#define RADV_CMD_DIRTY_CB_RENDER_STATE         (1ull << 19)
#define RADV_CMD_DIRTY_VIEWPORT_STATE          (1ull << 20)
#define RADV_CMD_DIRTY_BINNING_STATE           (1ull << 21)
#define RADV_CMD_DIRTY_FSR_STATE               (1ull << 22)
#define RADV_CMD_DIRTY_RAST_SAMPLES_STATE      (1ull << 23)
#define RADV_CMD_DIRTY_DEPTH_BIAS_STATE        (1ull << 24)
#define RADV_CMD_DIRTY_VS_PROLOG_STATE         (1ull << 25)
#define RADV_CMD_DIRTY_BLEND_CONSTANTS_STATE   (1ull << 26)
#define RADV_CMD_DIRTY_SAMPLE_LOCATIONS_STATE  (1ull << 27)
#define RADV_CMD_DIRTY_SCISSOR_STATE           (1ull << 28)
#define RADV_CMD_DIRTY_TESS_DOMAIN_ORIGIN_STATE (1ull << 29)
#define RADV_CMD_DIRTY_LS_HS_CONFIG            (1ull << 30)
#define RADV_CMD_DIRTY_VGT_PRIM_STATE          (1ull << 31)
#define RADV_CMD_DIRTY_FORCE_VRS_STATE         (1ull << 32)
#define RADV_CMD_DIRTY_NGGC_VIEWPORT           (1ull << 33)
#define RADV_CMD_DIRTY_NGGC_SETTINGS           (1ull << 34)
#define RADV_CMD_DIRTY_PS_EPILOG_SHADER        (1ull << 35)
#define RADV_CMD_DIRTY_PS_EPILOG_STATE         (1ull << 36)
#define RADV_CMD_DIRTY_GFX12_HIZ_WA_STATE      (1ull << 37)
#define RADV_CMD_DIRTY_ALL                     ((1ull << 38) - 1)

#define RADV_CMD_DIRTY_SHADER_QUERY (RADV_CMD_DIRTY_NGG_STATE | RADV_CMD_DIRTY_TASK_STATE)
